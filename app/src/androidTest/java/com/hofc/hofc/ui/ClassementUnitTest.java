...
public class ClassementUnitTest extends ActivityInstrumentationTestCase2<Accueil> {
    ...
    public ClassementUnitTest() throws Exception {
        super(Accueil.class);
    }
    ...
    @Test
    public void changeToClassement() {
        Accueil activity = getActivity();
    ...
    @Test
    public void changeClassementNumber() throws Exception {
        Accueil activity = getActivity();
        openDrawer(R.id.drawer_layout);
        onView(withText("Classement")).perform(click());
        FragmentManager fragmentManager = activity.getSupportFragmentManager();
        Fragment fragment = fragmentManager.findFragmentById(R.id.container);
        ListView list = (ListView)fragment.getView().findViewById(R.id.classement_listView);
        assertEquals(list.getAdapter().getCount(), 4); // Retourne +1 à cause de l'en tete ...
        assertEquals(list.getAdapter().getItem(0), null);
    }
